...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-8wu215fxx%#@)mnid$0y-k@!s5_bfdkaky=%z4em+&zgf$gs2x')
...
ALLOWED_HOSTS = ["https://ttex.tv2fyn.local/", "ttex.tv2fyn.local", "192.168.159.10" ]
